    ...
    return (
        <>
            <form onSubmit={handleSubmit} onReset={handleReset}>
                <input type="text" placeholder="Digite o seu Login" name="login" value={inputs.login || ""} onChange={handleChange}></input>

                <input type="password" placeholder="Digite a sua Senha" name="senha" value={inputs.senha || ""} onChange={handleChange}></input>
